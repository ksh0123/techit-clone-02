      ...
      <div className="container flex justify-between items-center">
        <div className="flex items-center">
          ...
          <ul className="hidden lg:flex">
            <li className="header-menu cursor-pointer">테킷 스쿨</li>
            <li className="header-menu relative cursor-pointer">
            ...
            <li className="header-menu cursor-pointer">스타트업 스테이션</li>
            <li className="header-menu border-r cursor-pointer">이벤트</li>
            <li className="header-menu cursor-pointer">기업 해커톤</li>
          </ul>
        </div>
