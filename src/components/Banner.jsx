...
const Banner = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="bg-red-100 absolute w-[1280px] left-1/2 -translate-x-1/2 bottom-6">
        <div className="text-white w-fit bg-black bg-opacity-30 flex text-xs rounded-full gap-2 py-[5px] px-3">
          <div>
